...
#### Logic(s) x Inquilab
In a past exploration of public scholarship from Inquilab, lab director Sucheta Ghoshal served as the academic director of the critcal tech magazine [Logic(s)](logicmag.io). Inquilab influenced into Logic(s) resulted in critical tech scholarship that interrogated contemporary computing tools in their materiality while mapping out the social, political, economic, and historical entanglements. **Funding:** INCITE at Columbia University, private donors.
